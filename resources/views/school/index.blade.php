...
<div class="container-fluid g-0" id="home">
  ...
  <div class="banner-messages">
    <h3>Wellcome to EduTech Academy</h3>
  ...
  <div class="content_body">
    <div class="row">
      ...
      <div class="card" style="width: 18rem;">
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center"><span>Price:
          <del>{{ $populer->sell_price }}</del> {{ $populer->price }}</span>
...
<div class="conatiner-fluid bg-primary py-5 px-3" id="feedbackSection">
  ...
  <div class="owl-carousel">
   ...
   @foreach ($feedbacks as $fedbk)
   <div class="card card-primary card-outline">
      <div class="card-body box-profile">
        <div class="d-flex justify-content-center">
          @if($fedbk->user->img )
          <img style="width: 70px;height:70px; object-fit:cover; border: 2px solid pink;border-radius: 50%;padding: 5px;"
          class="profile-user-img img-fluid img-circle"  src="{{ asset('storage')."/".$fedbk->user->img }}" alt="profile ">
          @else
          <img style="width: 70px; border: 2px solid pink;border-radius: 50%;padding: 5px;"
          class="profile-user-img img-fluid img-circle" src="{{ asset('school') }}/img/default-avatar.png" alt="profile ">
        ...
        <p class="text-center">{{ $fedbk->created_at }}</p>
